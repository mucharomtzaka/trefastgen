 ...
 <div class="box-header with-border">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('dynamic_menu'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
			...
			<td><?php echo $dynamic_menu->icon ?></td>
			...
			<td style="text-align:center">
				...
				echo ' | '; 
				echo anchor(site_url('dynamic_menu/delete/'.$dynamic_menu->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure  to Delete ?\')" class="btn btn-danger"><i class="fa fa-trash"></i'); 
				?>
			</td>
		</tr>
                <?php
